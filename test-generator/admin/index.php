...
// condicion para ejecutar el codigo
        ...
        <form action="<?= isset($test_edit) ? '/admin?test_edit_id='.$test_edit['id'] : '/admin' ?>" method="POST" class="card">
            ...
            <div class="card-body">
                <div class="form group">
                    ...
                    <input value="<?= isset($test_edit['title'])? $test_edit['title'] : '' ?>" type="text" name="title" id="title" class="form-control">
                </div>
                <div class="form group">
                    ...
                    <select name="grade" id="grade" class="form-select">
                        ...
                        ?>
                            <option <?php if(isset($test_id)){ if($test_edit['grade_id'] == $grade['id']){ echo 'selected';} } ?> value="<?= $grade['id'] ?>"><?= $grade['grade'] ?></option>
                        <?php
                        } ?>
                    </select>
                </div>
                <div class="form group mt-2">
                    ...
                    <textarea name="description" id="description" cols="20" rows="5" class="form-control"> <?= isset($test_edit['description']) ?  $test_edit['description'] : '' ?> </textarea>
                </div>
